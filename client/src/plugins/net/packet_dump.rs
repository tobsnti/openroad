...
//! blowfish-encrypted, `P` = plaintext. Without it a length read out of
...
mod tests {
    ...
    /// A dump line of `<ts> <hex>` alone leaves a padded encrypted body and a
    /// plaintext one of the same length indistinguishable after the
