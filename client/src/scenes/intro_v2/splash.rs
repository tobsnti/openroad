...
/// draws **448x150 at (180,224)**, where it used to be drawn at its native
/// 896x300 — twice too large.
///
...
mod tests {
    ...
    /// The defect this pins: `GDR_STA_BIGLOGO` `Rect="360,448,896,300"` at
    /// `k = 800/1600 = 0.5` is **448x150 at (180,224)** — the art was drawn at
    /// its native 896x300, twice too large and off the edge of a 640x480 window.
    #[test]
    fn the_splash_logo_is_half_size_on_an_800x600_client() {
        ...
        // The old, wrong draw, spelled out so this test fails if anyone puts it
